...
- **2026-06-24 (dispatch #485):** mx.indigo Mode 1 (`+00:00`), owner Mode 2 (float). Fixed, scan created 1 signal (Lavash/DoorDash).
- **2026-06-23:** Mode 1 on owner token. Fixed, scan processed 599 messages and created 142 signals.