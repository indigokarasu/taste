...
`~/.hermes/profiles/indigo/.env`, but `SPOTIFY_REFRESH_TOKEN` is absent.
...
**Second wiring gap (fixed proactively):** once Jared authorizes, the helper
