...
```json
{
  ...
  "email_sources": {
    "doordash": { "sender_patterns": ["no-reply@doordash.com", "contact@example.com"], "domain": "restaurant", "source_type": "purchase" },
    ...
    "amazon": { "sender_patterns": ["contact@example.com", "contact@example.com"], "domain": "product", "source_type": "purchase" },
